...
def measure(name, bn=True, copy_net=True, force_clean=True, **impl_args):   #装饰器的外层壳子
    # 在measure函数中定义make_impl函数
    def make_impl(func):    # 真正的装饰器
        # 在make_impl函数中定义measure_impl函数
